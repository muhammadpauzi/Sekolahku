...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $guru = $objGuru->query("SELECT * FROM guru WHERE id=$id")[0];
    if (empty($guru)) {
...
<head>
    ...
    <title>Ubah Data Guru - Sekolahku</title>
</head>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col">
                                            ...
                                            <button type="submit" name="ubah_guru" class="btn btn-info float-right"><i class="fa fa-plus mr-1"></i> Ubah Data Guru</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
