...
if (isset($_POST['cari'])) {
    $murid = $objMurid->cari($_POST['keyword'], 'murid');
} else {
            ...
            <div class="col">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <div class="row px-2">
                            <div class="col">
                                <?= Message::showMessage('message_murid'); ?>
                            </div>
                        </div>
                        <div class="row px-2 justify-content-between">
                            <div class="col-md-4">
                                <a href="tambah.php" class="btn btn-info"><i class="fa fa-plus mr-1"></i> Tambah Data Murid</a>
                            </div>
                            <div class="col-md-5">
                                <form action="" method="post">
                                    <div class="input-group input-group-cari">
                                        <input type="text" class="form-control" placeholder="Cari murid.." name="keyword" autocomplete="off" autofocus>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($murid as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="ubah.php?id=<?= $m['id']; ?>" class="badge badge-primary">Ubah</a>
                                                        <a href="hapus.php?id=<?= $m['id']; ?>" class="badge badge-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
